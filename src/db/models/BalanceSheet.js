...
const BalanceSheetSchema = new mongoose.Schema({
  ...
  companyType: { type: String, enum: ["public", "private"], required: true }, // Public or Private company
  filingType: { type: String, enum: ["10-Q", "10-K", "Private"], required: true }, // Filing type (SEC or private)
  filingDate: { type: Date, required: true }, // Full date of filing (includes year)
  ...
  currency: { type: String, default: "USD" }, 
	...
	assets: {
		...
		nonCurrentAssets: {
			...
			totalNonCurrentAssets: { type: Number, required: true },
		},
	},
	...
	liabilities: {
		...
		currentLiabilities: {
			...
			totalCurrentLiabilities: { type: Number, required: true },
		},
		nonCurrentLiabilities: {
			...
			totalNonCurrentLiabilities: { type: Number, required: true },
		},
	},
